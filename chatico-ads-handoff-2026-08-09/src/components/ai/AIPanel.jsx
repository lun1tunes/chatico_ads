...
export default function AIPanel() {
  ...
  return (
    <>
      ...
      >
        {/* Шапка панели — строго h-16, как топбар и шапка сайдбара */}
        <header className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-outline bg-white px-4">
