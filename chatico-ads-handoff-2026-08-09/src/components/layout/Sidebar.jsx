...
import CampaignsNavSection from './CampaignsNavSection';
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* 1. Шапка (Header) на чистом белом фоне — строго h-16, как топбар */}
      <div className="flex h-16 shrink-0 items-center gap-3 border-b border-outline bg-white px-6">
      ...
      {/* Навигация — Рекламные кампании · Настройки */}
      <div className="flex min-h-0 flex-1 flex-col gap-1 px-3 py-4 overflow-y-auto">
        <ul className="space-y-1">
          <li>
            <CampaignsNavSection isCollapsed={isCollapsed} />
          </li>
        </ul>
      </div>
